# Woodchopping Handicap Management System — Deliverable 2 (V2)

> Phase 3 of 3. This is the final V2 implementation of the Woodchopping Handicap Calculator submitted for BMIS 365 (Fall 2025). It supersedes the V1 implementation in `../project-deliverable-1/` by replacing the deterministic wood-index formula with LLM-assisted prediction and adding Monte Carlo fairness validation.
